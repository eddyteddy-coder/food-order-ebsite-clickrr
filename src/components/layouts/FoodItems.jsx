...
export default function FoodItems({fooditem , restaurant }) {
        ...
        <img src={fooditem.images[0].url}
         ...
         <div className="card-body d-flex flex-column">
            ...
            <br />
             ...
             {
              !showButtons ? (
                <button type="button" id="cart-btn" className='btn btn-primary d-inline ml-4'
                disabled={fooditem.stock===0} onClick={addToCartHandler}>Add to Cart</button>
              ):(
            ...
            <p>Staus:{" "}
                ...
                <span id="stock-status" className={fooditem.stock ? "greenColor" : "redColor"}>
                    {
