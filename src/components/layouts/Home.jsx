    ...
    {restaurantsLoading ? <Loader /> : restaurantsError ? (<Message variant="danger">{restaurantsError}</Message>):(
     ...
     <section>
        <div className='sort'>
            ...
            <button className='sort_veg p-3' onClick={handleSortByReview}>Sort by Review</button>
            <button className='sort_veg p-3'onClick={handleSortByRatings}>Sort By Ratings</button>
